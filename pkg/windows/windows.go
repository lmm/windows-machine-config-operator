...
func New(ipAddress, instanceID, machineName, workerIgnitionEndpoint, vxlanPort, networkType string, signer ssh.Signer, platform oconfig.PlatformType) (Windows, error) {
